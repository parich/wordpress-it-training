...
- [ ] [Client--Server Model](Client_Server_Model.md)
...
- [ ] Page View, Users, Sessions
- [ ] Install GA Script (Manual / Plugin)
- [ ] Basic Event Tracking
- [ ] Privacy & PDPA Overview
...
- [ ] What is a Tag?
- [ ] What is a Trigger?
- [ ] Why Developers Should Know GTM

---

## 3. Google Search Console (Webmaster Tool)
...
## 4. Web Speed & Performance Testing
...
- [ ] Disable Comments (Discussion Settings)
...
## 7. Final Project Challenge

Students must:

- [ ] Install WordPress (Docker or Local)
- [ ] Create 4 Pages
...
- [ ] Analyze Other WordPress Sites
- [ ] Install & Configure Analytics
- [ ] Perform SEO Submission
